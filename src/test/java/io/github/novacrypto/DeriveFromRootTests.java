...
public final class DeriveFromRootTests {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][]{
                {"m/44'/0'/0'/0/0", m().purpose(44).coinType(0).account(0).external().address(0)},
                {"m/44'/0'/0'/0/1", m().purpose(44).coinType(0).account(0).external().address(1)},
                {"m/44'/0'/0'/1/0", m().purpose(44).coinType(0).account(0).internal().address(0)},
                {"m/44'/0'/1'/0/0", m().purpose(44).coinType(0).account(1).external().address(0)},
                {"m/44'/1'/0'/0/0", m().purpose(44).coinType(1).account(0).external().address(0)},
                {"m/49'/0'/0'/0/0", m().purpose(49).coinType(0).account(0).external().address(0)}
        });
    }
